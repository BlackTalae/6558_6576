...
{
  new (message_memory) teleop_interfaces::srv::GivePosition_Request(_init);
}

void GivePosition_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<teleop_interfaces::srv::GivePosition_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GivePosition_Request_message_member_array[2] = {
  {
    ...
    offsetof(teleop_interfaces::srv::GivePosition_Request, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(teleop_interfaces::srv::GivePosition_Request, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GivePosition_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(teleop_interfaces::srv::GivePosition_Request),
...
get_message_type_support_handle<teleop_interfaces::srv::GivePosition_Request>()
{
  return &::teleop_interfaces::srv::rosidl_typesupport_introspection_cpp::GivePosition_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_interfaces, srv, GivePosition_Request)() {
  return &::teleop_interfaces::srv::rosidl_typesupport_introspection_cpp::GivePosition_Request_message_type_support_handle;
}
...
void GivePosition_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) teleop_interfaces::srv::GivePosition_Response(_init);
}

void GivePosition_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<teleop_interfaces::srv::GivePosition_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GivePosition_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(teleop_interfaces::srv::GivePosition_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GivePosition_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(teleop_interfaces::srv::GivePosition_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<teleop_interfaces::srv::GivePosition_Response>()
{
  return &::teleop_interfaces::srv::rosidl_typesupport_introspection_cpp::GivePosition_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_interfaces, srv, GivePosition_Response)() {
  return &::teleop_interfaces::srv::rosidl_typesupport_introspection_cpp::GivePosition_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GivePosition_service_members = {
  ...
  // see get_service_type_support_handle<teleop_interfaces::srv::GivePosition>()
...
get_service_type_support_handle<teleop_interfaces::srv::GivePosition>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::teleop_interfaces::srv::rosidl_typesupport_introspection_cpp::GivePosition_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_interfaces, srv, GivePosition)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<teleop_interfaces::srv::GivePosition>();
}
