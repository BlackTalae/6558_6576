...
#ifndef TELEOP_INTERFACES__SRV__DETAIL__CLEAR_PATH__FUNCTIONS_H_
#define TELEOP_INTERFACES__SRV__DETAIL__CLEAR_PATH__FUNCTIONS_H_
...
/// Initialize srv/ClearPath message.
/**
...
/// Finalize srv/ClearPath message.
/**
...
/// Create srv/ClearPath message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * teleop_interfaces__srv__ClearPath_Request__init().
...
/// Destroy srv/ClearPath message.
/**
 * It calls
 * teleop_interfaces__srv__ClearPath_Request__fini()
...
/// Check for srv/ClearPath message equality.
/**
...
/// Initialize array of srv/ClearPath messages.
/**
...
/// Finalize array of srv/ClearPath messages.
/**
 * It calls
 * teleop_interfaces__srv__ClearPath_Request__fini()
...
/// Create array of srv/ClearPath messages.
/**
 * It allocates the memory for the array and calls
 * teleop_interfaces__srv__ClearPath_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ClearPath messages.
/**
 * It calls
 * teleop_interfaces__srv__ClearPath_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ClearPath message array equality.
/**
...
/// Copy an array of srv/ClearPath messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * teleop_interfaces__srv__ClearPath_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_teleop_interfaces
...
/**
 * It calls
 * teleop_interfaces__srv__ClearPath_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_teleop_interfaces
...
/**
 * It allocates the memory for the array and calls
 * teleop_interfaces__srv__ClearPath_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_teleop_interfaces
...
/**
 * It calls
 * teleop_interfaces__srv__ClearPath_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TELEOP_INTERFACES__SRV__DETAIL__CLEAR_PATH__FUNCTIONS_H_
