...
static const _MakePath_Request_type_support_symbol_names_t _MakePath_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_interfaces, srv, MakePath_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_interfaces, srv, MakePath_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, teleop_interfaces, srv, MakePath_Request)() {
  return &::teleop_interfaces::srv::rosidl_typesupport_c::MakePath_Request_message_type_support_handle;
}
...
static const _MakePath_Response_type_support_symbol_names_t _MakePath_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_interfaces, srv, MakePath_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_interfaces, srv, MakePath_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, teleop_interfaces, srv, MakePath_Response)() {
  return &::teleop_interfaces::srv::rosidl_typesupport_c::MakePath_Response_message_type_support_handle;
}
...
static const _MakePath_type_support_symbol_names_t _MakePath_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_interfaces, srv, MakePath)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_interfaces, srv, MakePath)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, teleop_interfaces, srv, MakePath)() {
  return &::teleop_interfaces::srv::rosidl_typesupport_c::MakePath_service_type_support_handle;
}
