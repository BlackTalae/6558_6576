...
#include "teleop_interfaces/srv/detail/give_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const teleop_interfaces::srv::GivePosition_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  teleop_interfaces::srv::GivePosition_Request & ros_message)
{
  // Member: x
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleop_interfaces::srv::GivePosition_Request;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const teleop_interfaces::srv::GivePosition_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleop_interfaces::srv::GivePosition_Request *>(
    untyped_ros_message);
...
{
  return &teleop_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_interfaces, srv, GivePosition_Request)() {
  return &teleop_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_teleop_interfaces
cdr_serialize(
  const teleop_interfaces::srv::GivePosition_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  teleop_interfaces::srv::GivePosition_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = teleop_interfaces::srv::GivePosition_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const teleop_interfaces::srv::GivePosition_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<teleop_interfaces::srv::GivePosition_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &teleop_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_interfaces, srv, GivePosition_Response)() {
  return &teleop_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition_Response__handle;
}
...
{
  return &teleop_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_interfaces, srv, GivePosition)() {
  return &teleop_interfaces::srv::typesupport_fastrtps_cpp::_GivePosition__handle;
}
