...
static const _ClearPath_Request_type_support_symbol_names_t _ClearPath_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_interfaces, srv, ClearPath_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_interfaces, srv, ClearPath_Request)),
  }
};
...
{
  return &::teleop_interfaces::srv::rosidl_typesupport_cpp::ClearPath_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, teleop_interfaces, srv, ClearPath_Request)() {
  return get_message_type_support_handle<teleop_interfaces::srv::ClearPath_Request>();
}
...
static const _ClearPath_Response_type_support_symbol_names_t _ClearPath_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_interfaces, srv, ClearPath_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_interfaces, srv, ClearPath_Response)),
  }
};
...
{
  return &::teleop_interfaces::srv::rosidl_typesupport_cpp::ClearPath_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, teleop_interfaces, srv, ClearPath_Response)() {
  return get_message_type_support_handle<teleop_interfaces::srv::ClearPath_Response>();
}
...
static const _ClearPath_type_support_symbol_names_t _ClearPath_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_interfaces, srv, ClearPath)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_interfaces, srv, ClearPath)),
  }
};
...
{
  return &::teleop_interfaces::srv::rosidl_typesupport_cpp::ClearPath_service_type_support_handle;
}
